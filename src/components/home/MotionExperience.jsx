...
const MotionExperience = () => {
  const [activeTab, setActiveTab] = useState('shutter');
  ...
  return (
    <section className="relative py-24 bg-[#050d1a] bg-gradient-cta border-y border-slate-800 overflow-hidden text-white">
      {/* Decorative background grid */}
      <div className="absolute inset-0 geo-pattern-4 opacity-[0.03] pointer-events-none" />
      
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center mb-12">
          <span className="text-blue-400 text-xs font-mono tracking-[0.3em] uppercase">Interactive Experiences</span>
          ...
          <div className="w-16 h-[2px] bg-blue-400 mx-auto mt-6" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 w-full flex flex-col items-center justify-center p-4">
            ...
            <div className="mt-6 w-full max-w-[480px] flex items-center justify-between text-xs font-mono text-slate-400">
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-center">
            <span className="text-blue-400 font-mono text-xs font-semibold tracking-wider uppercase">Interactive Spotlight</span>
            <h3 className="font-sans font-bold tracking-tight text-3xl text-white">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                {currentProduct.specs.map((spec, idx) => (
                  <div key={idx} className="flex justify-between items-center py-2 border-b border-slate-800 text-sm">
                    <span className="text-slate-400 font-body">{spec.label}</span>
                    <span className="text-white font-bold font-sans">{spec.val}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <a
              ...
              className="w-full py-3 bg-white hover:bg-blue-400 text-[#050d1a] hover:text-white text-center font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 text-sm"
            >
