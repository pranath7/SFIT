    ...
    <>
      ...
      <div className={`transition-opacity duration-500 ${loading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <div className="mobile-bottom-bar md:hidden">
          <a
            href="https://wa.me/919962285822"
            target="_blank"
            rel="noopener noreferrer"
            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-whatsapp text-white rounded-lg font-semibold text-sm"
          >
          ...
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-accent-blue text-white rounded-lg font-semibold text-sm"
          >
